...
const Hero = () => {
  return (
    <section className="relative h-[85vh] flex items-center justify-center overflow-hidden bg-[#0A0A0A] text-white">
      {/* Glow */}
...
"
        ...
        >
          ...
          <p className="mt-10 text-zinc-600 tracking-[6px] text-xs uppercase">
  Curated Luxury • Rare Artifacts • Timeless Legacy
</p>
        </motion.div>
      </div>
    </section>
